$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '评论人邮箱', name: 'email', index: 'email', width: 60},
    ...
    function statusFormatter(cellvalue) {
        if (cellvalue == 1) {
            return "<button type=\"button\" class=\"btn btn-block btn-secondary btn-sm\" style=\"width: 80%;\">已禁止显示</button>";
        }
        else if (cellvalue == 0) {
            return "<button type=\"button\" class=\"btn btn-block btn-success btn-sm\" style=\"width: 80%;\">正常显示</button>";
        }
    }
