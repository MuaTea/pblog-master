$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '链接名称', name: 'linkName', index: 'linkName', width: 100},
            {label: '链接地址', name: 'linkUrl', index: 'linkUrl', width: 120},
            {label: '链接描述', name: 'linkDescription', index: 'linkDescription', width: 120},
